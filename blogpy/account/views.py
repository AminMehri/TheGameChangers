...
class Register(CreateView):
    ...
    def form_valid(self, form):
        ...
        email.send()
        return HttpResponse('We sent a email for you. please check your email to complete the registration')
...
def activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        user.is_active = True
        user.save()
        return HttpResponse('Thank you for your email confirmation. Now you can login your account. <a class="text-primary" href="/login">click here</a>')
    else:
